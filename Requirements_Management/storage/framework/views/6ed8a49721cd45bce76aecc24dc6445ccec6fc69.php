...
unset($__errorArgs, $__bag); ?>
              ...
              Don't have an account? <a href="<?php echo e(route('register')); ?>">SignUp Now</a>
            </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Year-3-Semester-2-ITPM\Requirements_Management\resources\views/auth/login.blade.php ENDPATH**/ ?>