                        ...
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0" style="font-style: italic;">Requirements Information</h4></div>
                              <div class="btn-group mb-2">
                                   <!-- <a href="<?php echo e(url('generate-report')); ?>"  class="btn btn-danger "> <i class="fa fa-cloud-download"></i>&nbsp; Requirement PDF</a> -->
                                    ...
                                    <table id="example" class="display table dataTable table-striped table-bordered shadow p-3 mb-5 bg-white rounded">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                              ...
                                              <td align="center"><?php echo e($item->preferred_time); ?></td>
                                                    <td align="center">
                                                                                ...
                                                                                <a href="<?php echo e(url('generate-report',$item->id )); ?>"  class="btn btn-danger "> <i class="fa fa-cloud-download"></i>&nbsp;&nbsp;Download</a>                                                                                                                                   
                                                    </td>
                                            </tr>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               <a href="<?php echo e(url('/ad-requirements')); ?>">
...
<?php echo $__env->make('Admin.Adlayout.adapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Year-3-Semester-2-ITPM\Requirements_Management\resources\views/Admin/AdRequiremets/Adrequirements.blade.php ENDPATH**/ ?>