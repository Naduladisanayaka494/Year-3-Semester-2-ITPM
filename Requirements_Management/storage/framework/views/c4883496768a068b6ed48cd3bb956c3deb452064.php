...
<?php echo $__env->make('Admin.Adlayout.adheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('Admin.Adlayout.adslidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('Admin.Adlayout.adfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- General JS Scripts -->
  ...
  <script src="<?php echo e(asset('/template/template/node_modules/jquery.nicescroll/dist/jquery.nicescroll.min.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('/template/template/assets/js/stisla.js')); ?>"></script>

  <!-- JS Libraies -->

  <!-- Template JS File -->
  <script src="<?php echo e(asset('/template/template/assets/js/scripts.js')); ?>"></script>
  <script src="<?php echo e(asset('/template/template/assets/js/custom.js')); ?>"></script>
 <!-- START: Template JS-->
...
<?php /**PATH D:\Year-3-Semester-2-ITPM\Requirements_Management\resources\views/Admin/adlayout/adapp.blade.php ENDPATH**/ ?>