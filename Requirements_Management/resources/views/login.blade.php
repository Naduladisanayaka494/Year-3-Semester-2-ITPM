      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <img alt="image" src="{{ asset('/template/template/assets/img/avatar/Admin.jpg') }}" width="100" class="rounded-circle">
            </div>

            <div class="card card-primary shadow p-3 mb-5 bg-body rounded">
              <div class="card-header"><h4> <i class="fa-solid fa-star"></i> Login User!</h4></div>
              <div class="card-body">
                  <div class="form-group">
                    <a href="{{url('dashboard')}}"><button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                      Login
                    </button></a>
                  </div>
              </div>
            ...
            <div class="simple-footer">
              Copyright &copy; SLIIT UNIVERSITY
            </div>
          </div>
        </div>
      </div>
